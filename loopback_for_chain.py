...
class Script(scripts.Script):
    ...
    def ui(self, is_img2img):
        ...
        denoising_curve = gr.Dropdown(label="Denoising strength curve", choices=["Aggressive", "Linear", "Lazy"], value="Linear", elem_id=self.elem_id("denoising_curve"))
        append_interrogation = gr.Dropdown(label="Append interrogated prompt at each iteration", choices=["None", "CLIP", "DeepBooru"], value="None", elem_id=self.elem_id("append_interrogation"))
